import { Inter, Roboto, Markazi_Text, Mona_Sans } from 'next/font/google'
...
export default function RootLayout({
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      ...
      <body className={`${inter.className} ${roboto.className} ${markaziText.variable} ${monaSans.variable}`} suppressHydrationWarning>
        {children}
      </body>
    </html>
  );
